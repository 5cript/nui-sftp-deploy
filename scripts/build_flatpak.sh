...
# flatpak-builder --user --install-deps-from=flathub build/flatpak org.nuicpp.nui_sftp.yml
flatpak-builder --user --force-clean --install-deps-from=flathub build/flatpak org.nuicpp.nui_sftp.yml
